...
data_root = '/home/zou/MMCV/mmsegmentation/data/RIT-18'
img_scale = (512, 512)
crop_size = (512, 512)
batch_size = 2
train_tif_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        type='R18dataset',
        data_root='/home/zou/MMCV/mmsegmentation/data/RIT-18',
        img_dir='sun_band_img/',
        ann_dir='sun_label/'),
    val=dict(
        type='R18dataset',
        data_root='/home/zou/MMCV/mmsegmentation/data/RIT-18',
        img_dir='shadow_band_img',
...
fp16 = dict()
work_dir = '/home/zou/MMCV/mmsegmentation/LogFiles/ConvNeXt/RIT-18/convnext/band'
gpu_ids = [0]
auto_resume = False
